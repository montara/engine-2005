...
class Application(object):
    ...
    def _createCamera(self):
        ...
        self.camera.setPosition(ogre.Vector3(490, 35, 480))
        self.camera.lookAt(ogre.Vector3(500, 30, 500))
    ...
    def _createViewports(self):
        ...
        self.viewport.BackgroundColour = ogre.ColourValue(0.25,0.1,0.25)
